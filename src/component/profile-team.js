class ProfileTeams extends HTMLElement {
  constructor() {
    super();
                    ...
                    <div class="max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-[#C6C6C6] dark:text-gray-800">
                        ...
                        <div class="space-y-4 text-center divide-y dark:divide-gray-300">
                            <div class="my-2 space-y-1">
                                ...
                                <p class="px-5 text-xs sm:text-base dark:text-gray-600">Universitas Majalengka</p><br>
                            </div>
                            <div class="flex justify-center pt-2 space-x-4 align-center">
                                <a rel="noopener noreferrer" href="#" aria-label="GitHub" class="p-2 rounded-md dark:text-gray-800 hover:text-[#FA2D00]">
                                ...
                                <a rel="noopener noreferrer" href="#" aria-label="Dribble" class="p-2 rounded-md dark:text-gray-800 hover:text-[#FA2D00]">
                                ...
                                <a rel="noopener noreferrer" href="#" aria-label="Twitter" class="p-2 rounded-md dark:text-gray-800 hover:text-[#FA2D00]">
                                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current">
                                ...
                                <a rel="noopener noreferrer" href="#" aria-label="Email" class="p-2 rounded-md dark:text-gray-800 hover:text-[#FA2D00]">
                                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current">
                    ...
                    <div class="max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-[#C6C6C6] dark:text-gray-800">
                        ...
                        <div class="space-y-4 text-center divide-y dark:divide-gray-300">
                            <div class="my-2 space-y-1">
                                ...
                                <p class="px-5 text-xs sm:text-base dark:text-gray-600">Politeknik Negeri Batam</p>
                            </div>
                            <div class="flex justify-center pt-2 space-x-4 align-center">
                                <a rel="noopener noreferrer" href="#" aria-label="GitHub" class="p-2 rounded-md dark:text-gray-800 hover:text-[#FA2D00]">
                                    <svg viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current">
                    ...
                    <div class="max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-[#C6C6C6] dark:text-gray-800">
                        ...
                        <div class="space-y-4 text-center divide-y dark:divide-gray-300">
                            <div class="my-2 space-y-1">
                                ...
                                <p class="px-5 text-xs sm:text-base dark:text-gray-600">Universitas Majalengka</p>
                            </div>
                            <div class="flex justify-center pt-2 space-x-4 align-center">
                                <a rel="noopener noreferrer" href="#" aria-label="GitHub" class="p-2 rounded-md dark:text-gray-800 hover:text-[#FA2D00]">
                                    <svg viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current">
...
customElements.define("profile-teams", ProfileTeams);
