class ProfileTeams extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
        ...
        <div class="w-full p-10 bg-[#F3FFE7]">
                <h1 class="text-3xl text-center font-bold mt-1 mb-10">Our <span class="text-[#FA2D00]">Team</span></h1>
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-1 justify-items-center">
                    ...
                    <div class="max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-[#C6C6C6] dark:text-gray-800">
                        ...
                        <div class="space-y-4 text-center divide-y dark:divide-gray-300">
                            <div class="my-2 space-y-1">
                                ...
                                <p class="px-5 text-xs sm:text-base dark:text-gray-600">Full-stack developer</p>
                            </div>
